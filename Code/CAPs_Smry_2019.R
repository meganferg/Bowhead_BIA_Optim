#Script CAPs_Smry.r...Megan C. Ferguson...22 December 2019
  ...
  #Input data
    load("Data//am_all_2019_v2.Rdata")
      ...
      #Do the following for each CAPs session
        caps.smry <- lapply(1:n.caps, function(i){
          ...
          #Number of unid sightings during CAPs passing
            #caps.dat$Species[c(3,10,11)] <- "unid cetacean" #For debugging only
          ...
          #Generate detailed CAPs passing sighting table
            ...
            if(n.pass.unid > 0 & n.sp > 0){  
                ...
                #                      0 if Behavior != "feed" or "mill"
                  ...
                  df.cols <- c(1,2,72,71,12,34,35,38,39,56,57,58,9,15) 
                  ...
                  all.caps.pass.df <- rbind.data.frame(new.unid.df, caps.pass.id.dat)[, c(1:13,15,14,17:19,16)]
